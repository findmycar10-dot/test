...
// CORS setup with multiple allowed origins (dev-friendly)
const allowedOrigins = (process.env.ALLOWED_ORIGINS || process.env.ALLOWED_ORIGIN || 'http://localhost:5173,http://localhost:8080,http://127.0.0.1:5173,http://127.0.0.1:8080')
  .split(',')
  .map(o => o.trim())
  .filter(Boolean);
